...
scrollToCurrentRow : function(){
    ...
    if(iRow <= this._iRowDispOffset + this._iViewOffset){
        ...
        // this.aniScroll(this._iScrollOffsetPx - ((this._iRowHeight || 20) * (iRow)), 400);
    }else{
        if(iRow + 1 > this._iRowDispOffset + this._iViewOffset + iViewSize){
            this.scrollTo((this._iRowHeight || 20) * (iRow - iViewSize + 1), true, false);
            // this.aniScroll(this._iScrollOffsetPx - ((this._iRowHeight || 20) * (iRow - iViewSize + 1)), 400);
        }
    }
...
handleDataPage : function(sType, sStartRowId, bFirst, bLast){
    ...
    if(sType === "last"){
        ...
        //  Update display
        this.updateScrollbarSize();
        this.scrollTo(this._eScrollStretch.clientHeight - this._eScrollbar.clientHeight, false, false);
        this._bNoRender = false;
        this.updatePosition();
    }
